...
struct TypographyReferenceView: View {
    ...
    private func dynamicPointSize(for style: Font.TextStyle, category: ContentSizeCategory) -> Int {
        let table: [ContentSizeCategory: [Font.TextStyle: CGFloat]] = [
        ...
        return Int(table[category]?[style] ?? 17)
    }
}
