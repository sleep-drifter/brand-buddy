...
func appDestination(for entry: AppEntry) -> some View {
    ...
    case "Reorder Containers":     ReorderContainersView()
    case "Swipe Anywhere":         SwipeAnywhereView()
    case "Toolbar Minimize":       ToolbarMinimizeView()
    case "Item Dialogs":           ItemDialogsView()
    case "Drag Collections":       DragCollectionsView()
    case "@State Macro Lab":       StateMacroLabView()
